...
if exist ..\src\process-clip\requirements.txt (
    pip install -r ..\src\process-clip\requirements.txt -t %BUILD_DIR% --quiet
...
cd %BUILD_DIR%
powershell Compress-Archive -Path * -DestinationPath ..\opus-process-clip.zip -Force
cd ..
